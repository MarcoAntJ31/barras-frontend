<template>
    <v-container fluid fill-height class="d-flex flex-row pa-0 ma-0">
        <!-- Sección de la cámara -->
        <v-col cols="12" md="6" class="d-flex flex-column justify-center align-center pa-0 ma-0">
            <v-card class="pa-5 fill-height" max-width="100%">
                <v-card-title class="headline text-center">Escáner de Códigos de Barras</v-card-title>
                <v-card-text class="d-flex flex-column justify-center align-center fill-height">
        ...
        <v-col cols="12" md="6" class="d-flex flex-column justify-center align-center pa-0 ma-0">
            <v-card class="pa-5 fill-height" max-width="100%">
                ...
                <v-card-text class="overflow-auto fill-height">
                    <v-list>
                        <v-list-item v-for="(item, index) in scanHistory" :key="index" class="mb-2">
                            <v-list-item-content>
                                ...
                                <v-list-item-subtitle>Escaneado: {{ new Date(item.created_at).toLocaleString()
